...
const EducationWork = ({ educationTimeline, workTimeline }) => {
  ...
  useEffect(() => {
    ...
    initialRender.education,
    initialRender.experience,
    inViewExperience,
    inViewEducation,
    animationExperience1,
    animationExperience2,
    animationEducation1,
    animationEducation2,
  ]);
      ...
      <div className="container">
        ...
        >
          ...
          <motion.div className="rows" variants={container}>
            <div ref={refEducation} className="cols">
              <EduWorkCard
                titlee="My Education"
            ...
            <div ref={refExperience} className="cols">
              <EduWorkCard
