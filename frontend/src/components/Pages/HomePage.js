...
const HomePage = () => {
  ...
  return (
    <>
      <Banner homeDetails={user.home} />
      <AboutMe aboutDetails={user.about} languagesKnown={user.languagesKnown} />
      <EducationWork
        educationTimeline={user.educationTimeline}
        workTimeline={user.workTimeline}
      />
      <Skills skills={user.skills} skillImages={user.skillsCubeImg} />
      <Projects
