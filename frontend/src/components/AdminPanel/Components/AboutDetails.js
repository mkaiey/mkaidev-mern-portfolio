      ...
      <div className="adminpanel-form">
        <div className="admin-container-inputbox">
          ...
          <InputBox
            ...
            onChange={(e) =>
              setAbout({ ...about, phoneNumber: e.target.value })
            }
          />
          <InputBox
            label="Freelancing"
            ...
            onChange={(e) =>
              setAbout({ ...about, freeLancing: e.target.value })
            }
            select={true}
          />
          <InputBox
          ...
          <InputBox
            ...
            onChange={(e) =>
              setAbout({ ...about, cvfileLinkLight: e.target.value })
            }
          />
          <InputBox
            ...
            onChange={(e) =>
              setAbout({ ...about, cvfileLinkDark: e.target.value })
            }
          />
        </div>
