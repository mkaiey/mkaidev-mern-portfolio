...
const EducationTimeLine = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await dispatch(
      addEducationTimeline(title, description, startdate, enddate)
    );
    dispatch(getUser());
    setButtonText("Added");
  ...
  const handleUpdate = async (
    ...
    e.preventDefault();
    await dispatch(
      editEducationTimeline(id, title, description, startdate, enddate)
    );
    dispatch(getUser());
  };
        ...
        <div className="btncontiner">
          {!editId ? (
            ...
            <button
              ...
              disabled={loading}
              onClick={(e) =>
                handleUpdate(e, editId, title, description, startdate, enddate)
              }
            >
              Update
            </button>
